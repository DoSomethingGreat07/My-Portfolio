            ...
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-3xl mx-auto">
                    {experience.map((exp, index) => (
                        ...
                        >
                            {/* Timeline Line */}
                            <div className="absolute left-[9px] top-0 bottom-0 w-0.5 bg-border group-last:bottom-auto group-last:h-full" />
 
                            {/* Timeline Dot */}
                            <div className="absolute left-0 top-1.5 w-3 h-3 rounded-full bg-primary z-10 box-content border-4 border-background" />
